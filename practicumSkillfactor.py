...
print('''Список команд:  
        ...
        6. Вывод среднего балла по каждому предмету и ученику  
        7. Добавление предмета
        8. Удаление предмета
        9. Средний балла по каждому предмету по определенному ученику
        10. Информация по ученикам с плохой успеваемостью
        11. Информация по ученикам с хорошей успеваемостью  
...
while True:
    ...
    # Новый пункт для вывода среднего балла по предмету для ученика
        ...
        print('9. Средний балл по каждому предмету по определенному ученику')
        student = input('Введите имя ученика: ')
